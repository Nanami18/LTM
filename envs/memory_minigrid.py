...
def register_envs():
    ...
    gym.register(
        id="MiniGrid-MemoryS37-v0-seeobj-externalmem",
        entry_point="envs.memory_minigrid:MiniGrid_MemoryS13_v0_seeobj_externalmem",
        kwargs={"size":37}
    )
    gym.register(
        id="MiniGrid-MemoryS31-v0-seeobj-externalmem",
        entry_point="envs.memory_minigrid:MiniGrid_MemoryS13_v0_seeobj_externalmem",
        kwargs={"size":31}
    )
    gym.register(
        id="MiniGrid-MemoryS25-v0-seeobj-externalmem",
        entry_point="envs.memory_minigrid:MiniGrid_MemoryS13_v0_seeobj_externalmem",
        kwargs={"size":25}
    )
    gym.register(
        id="MiniGrid-MemoryS19-v0-seeobj-externalmem",
        entry_point="envs.memory_minigrid:MiniGrid_MemoryS13_v0_seeobj_externalmem",
        kwargs={"size":19}
    )
    gym.register(
        id="MiniGrid-MemoryS13-v0-seeobj-externalmem",
        entry_point="envs.memory_minigrid:MiniGrid_MemoryS13_v0_seeobj_externalmem",
    )
    gym.register(
        id="MiniGrid-MemoryS9-v0-seeobj-externalmem",
        entry_point="envs.memory_minigrid:MiniGrid_MemoryS13_v0_seeobj_externalmem",
        kwargs={"size":9}
    )
    gym.register(
        id="MiniGrid-MemoryS5-v0-seeobj-externalmem",
        entry_point="envs.memory_minigrid:MiniGrid_MemoryS13_v0_seeobj_externalmem",
        kwargs={"size":5}
    )
...
class MiniGrid_MemoryS13_v0_seeobj_externalmem(MemoryEnv):
    """
    This environment is a memory test. The agent starts in a small room
    where it sees an object. It then has to go through a narrow hallway
    which ends in a split. At each end of the split there is an object,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.observation_space = gym.spaces.Dict({
            ...
            'memory': gym.spaces.Discrete(3)
        })
        self.action_space = gym.spaces.Tuple((self.action_space, gym.spaces.Discrete(3)))
    ...
    def step(self, action):
        obs, reward, terminated, truncated, info = super().step(action[0])
        self.memory = action[1]
        obs['memory'] = self.memory
